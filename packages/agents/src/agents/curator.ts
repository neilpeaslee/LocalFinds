...
1. Call read_feedback. Fold anything new into profile.md ("Learned taste notes", dated bullets citing the feedback items). ${THUMBS_CLEAR_NOTE} Do this BEFORE curating.
