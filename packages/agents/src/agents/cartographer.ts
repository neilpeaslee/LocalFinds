...
export const cartographer: AgentDefinition = {
  name: "cartographer",
  defaultMaxTurns: 30,
  // Cartographer is mechanical ETL (query OSM via osm_query → transcribe named elements).
...
- Only store what OSM actually returned. Never invent names, addresses, phones, or coordinates.
