...
1. Call read_feedback. If there is feedback on your past finds, fold it into profile.md ("Learned preferences", dated bullets citing the feedback) BEFORE searching. ${THUMBS_CLEAR_NOTE}
