...
// HTTP only (no SDK/db imports beyond the shared ToolTextResult type), so it
// stays unit-testable via an injected fetchImpl.
import type { ToolTextResult } from "./tool-result";
